	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-4 my-0 p-0 shadow" style="min-height: 100vh">
				...
				<form class="p-4 bg-white" action="user-otp.php" method="POST" autocomplete="off">
					...
					<div class="form-group">
						<input class="btn btn-primary btn-block py-2 rounded" type="submit" name="check" value="Submit">
					</div>
				</form>
			</div>
		</div>
